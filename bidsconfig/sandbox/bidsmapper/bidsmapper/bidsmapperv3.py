...
print('\n Most sequences will be automatically added. If any sequences did not find a match, you will be prompted to provide a bids name.')
print('\n This code needs a valid json file inside the same directory to run. To test, open `bidsmap.json` and delete all but one object from the file.')
print('\n For production use, hard-code XNAT authentication and remove time.sleep() and print() functions to increase speed.')
print('\n-----------------------------------------------------------------\n ')
...
with requests.Session() as session:
    ...
    sequence_list = []
    ignore = ['LOC','ASL','EDT', 'ORIG', 'Screen_Save', 'CAL_ASSET', 'RFE', 'B0', ':']
    accept = ['FUNC', 'DTI', 'STRUC', 'func', 'FM',]
