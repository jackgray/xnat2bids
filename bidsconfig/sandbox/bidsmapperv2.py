...
# Use list of keywords to auto generate a bids equivalent
just_added = []
for i in sequence_list:
    for k in keywords:
        if re.findall(k, i, re.IGNORECASE):
            taskname = k.replace('_', '')
...
sequence_list = list(set(sequence_list).difference(just_added))
# Show user sequences that were just adde
